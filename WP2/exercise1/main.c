...
void move(ROBOT *robot) {
    ...
    switch (robot->dir) {
        case 0: if (robot->ypos > 0)robot->ypos--; break;
        case 1: if (robot->xpos < 99)robot->xpos++; break;
        case 2: if (robot->ypos < 99)robot->ypos++; break;
        case 3: if (robot->xpos > 0)robot->xpos--; break;
    }
}
